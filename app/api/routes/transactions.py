...
def get_recent_transactions(
    ...
    return get_public_transactions_by_user_id(current_user.user_id, limit=limit)
...
def get_account_transactions(
    ...
    user_accounts = get_accounts_by_user_id(current_user.user_id)
    allowed_account_ids = {account["account_id"] for account in user_accounts}
    ...
    return get_public_transactions_by_account_id(account_id, limit=limit)